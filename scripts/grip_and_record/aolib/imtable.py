...
PUBLIC_URL = 'http://169.229.222.157/tab'
WWW_PATH = '/home/ao/www/tab'

def show_table(table, title = None, rows_per_page = 100, show = False,
               base_dir = None, output_path = None, archive = True,
               use_www = False):
  ...
  if output_path is None:
    ...
    if base_dir is None:
      ...
      if os.path.exists('/home/rpatel/data_centroid_loc_robertoCODE'):
        base_dir = '/home/rpatel/data_centroid_loc_robertoCODE'
      else:
        base_dir = None
